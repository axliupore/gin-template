...
func (z *_zap) GetWriteSyncer(level string) zapcore.WriteSyncer {
	fileWriter := NewCutter(global.Config.Zap.Directory, level, WithCutterFormat("2006-01-02"))
	if global.Config.Zap.UserLoginConsole {
...
func (z *_zap) GetEncoderCore(l zapcore.Level, level zap.LevelEnablerFunc) zapcore.Core {
	writer := z.GetWriteSyncer(l.String()) // 日志分割
